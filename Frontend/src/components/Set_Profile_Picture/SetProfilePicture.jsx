...
import ProfilePictureBackground from "../../assets/ProfilePictureBackground.jpg";
...
const SetProfilePicture = () => {
  ...
  const handelProfilePicture = async (e) => {
    ...
    try {
      const response = await axios.patch(
        "http://localhost:3000/api/users/profilePicture",
        formData,
  ...
  return (
    <div className="w-full h-[100vh] border relative flex justify-center items-center gap-32">
      <img
        src={ProfilePictureBackground}
        className="size-full absolute bg-right"
        alt=""
      />
